...
public class Pinsetter
{
    ...
    */
	 ...
	 * */
	private void sendEvent(int jdpins)
	{
		// send events when our state is changed
		for (int i=0; i < subscribers.size(); i++)
		{
			subscribers.get(i).receivePinsetterEvent(new PinsetterEvent(pins, foul, throwNumber, jdpins));
		}
	}
